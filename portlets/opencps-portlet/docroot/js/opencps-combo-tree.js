...
(function ( $, window, document, undefined ) {
    ...
    function ComboTree( element, options ) {
        ...
        this.init(this.options.boundingBox);
    }

    ComboTree.prototype.init = function (boundingBox) {
        // Setting Doms
    ...
    ComboTree.prototype.createSourceItemHTML = function (sourceItem) {
        var itemHtml = "",isThereSubs=false;
//        console.log(sourceItem.children.length);
//        console.log(JSON.parse(sourceItem.children).length);
        ...
        if (this.options.isMultiple)
            ...
            itemHtml += '<span data-id="' + sourceItem.id + '" data-text="'+sourceItem.text+'" class="comboTreeItemTitle">' + sourceItem.text + '</span>';
    ...
    ComboTree.prototype.toggleSelectionTree = function (item, direction) {
        ...
        if (direction === undefined){
            if ($(subMenu).is(':visible'))
                $(item).children('span.comboTreeParentPlus').html('<span class="tree-hitarea icon-plus"></span>');
            else
                $(item).children('span.comboTreeParentPlus').html('<span class="tree-icon tree-folder tree-folder-open"></span>');
    ...
    ComboTree.prototype.singleItemClick = function (ctItem) {
        ...
        $(this.options.name).val($(ctItem).attr("data-id"));
        if(this.options.formSubmit){
        	submitForm(this.options.form);
        }
    ...
    ComboTree.prototype.setValue = function (value) {
    	var elementTemp = $('span[data-id="'+value+'"]');
    	this._selectedItem = {
    			id: elementTemp.attr("data-id"),
                title: elementTemp.attr("data-text")
        };
    	elementTemp.addClass('comboTreeItemSelected');
    	$(this.options.name).val(elementTemp.attr("data-id"));
    	$("#"+this.options.boundingBox).val(elementTemp.attr("data-text"));
